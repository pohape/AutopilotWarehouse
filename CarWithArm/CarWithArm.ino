...
void leftForward(int miliseconds) {
  ...
  for (int i = 0; i < (miliseconds / 20); i++) {
...
void rightForward(int miliseconds) {
...
void rightBack(int miliseconds) {
  digitalWrite(IN3,LOW);
...
//    msOfWork = millis() - rightForwardStarted;
//  } else if (leftCurrentlyMovingBack) {
//    msOfWork = millis() - rightBackStarted;
//  } else {
//    Serial.println(String(millis()) + ": Left stop requested on stopped wheels!");
//
//    return;
//  }
//  
//  Serial.println(String(millis()) + ": Left stop after " + String(msOfWork) + " ms of work");
...
//    msOfWork = millis() - rightForwardStarted;
//  } else if (rightCurrentlyMovingBack) {
//    msOfWork = millis() - rightBackStarted;
//  } else {
//    Serial.println(String(millis()) + ": Right stop requested on stopped wheels!");
//
//    return;
//  }
//  
//  Serial.println(String(millis()) + ": Right stop after " + String(msOfWork) + " ms of work");
